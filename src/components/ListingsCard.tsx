        ...
        <Card className="mx-4">
          ...
          >
            <div className="flex justify-start items-center w-full gap-3">
              <div className="w-16 xl:w-20 h-16 flex items-center justify-center rounded-full">
            ...
            <div className="icons flex w-full justify-end gap-2">
              ...
              <i className="fa-solid hidden md:block fa-eye cursor-pointer text-white text-lg px-3 py-2 rounded-full bg-red-500"></i>
            </div>
          </CardFooter>
        </Card>
      </Link>
